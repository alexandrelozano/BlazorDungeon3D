using static BlazorDungeon3D.Code.Game;
...
namespace BlazorDungeon3D.Code
{
    public class Map
    {
        ...
        string[] txtCells = {
            ...
            "100011111111111010101011111111111111101111111111111110111011101111101",
            "111000100000001010001000000010000000100010000000000010001000101000001",
        ...
        public Map()
        {
            ...
            mapCells[3, 21].item1 = ItemType.Apple;
            mapCells[3, 21].item2 = ItemType.Apple;

            mapCells[1, 18].item1 = ItemType.Apple;
            mapCells[1, 18].item2 = ItemType.Apple;
